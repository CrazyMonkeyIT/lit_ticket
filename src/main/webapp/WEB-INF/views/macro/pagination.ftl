    ...
    <div style="width:100%;border:0px solid red;text-align:center;position: relative;top:-20px;">
        <ul class="pagination" style="margin:0px auto;" >
            ...
            <#if (page.pageNum > 1)>
                ...
                <li><a href="javascript:${callFunName}(${page.pageNum} - 1)">上一页</a></li>
            </#if>
            <#list nums as index >
            ...
            <#if (page.pageNum < page.pages)>
                <li><a href="javascript:${callFunName}(${page.pageNum} + 1)">下一页</a></li>
                <li><a href="javascript:${callFunName}(${page.pages})">尾页</a></li>
            </#if>
